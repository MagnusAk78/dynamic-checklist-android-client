...
/**
 * An activity representing a single Checkpoint detail screen. This activity is
 * only used on handset devices. On tablet-size devices, item details are
 * presented side-by-side with a list of items in a
 * {@link CheckpointListActivity}.
 * <p>
...
public class CheckpointDetailActivity extends FragmentActivity 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.checkpoint_detail_container, fragment).commit();
        }
    }
